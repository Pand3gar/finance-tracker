...
export default function AddTransactionModal({ open, onClose, onSuccess, initialData }: AddTransactionModalProps) {
  ...
  return (
    <dialog
      ...
      className="m-auto w-[calc(100%-2rem)] max-w-md max-h-[90dvh] rounded-2xl border border-border bg-card p-0 shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] backdrop:bg-black/50 backdrop:backdrop-blur-sm open:flex open:flex-col overflow-hidden"
    >
