...
export default function ReportsPage() {
  ...
  return (
    <>
      {/* Header */}
      <header className="flex shrink-0 items-center justify-between px-2 pt-2 sm:sticky sm:top-0 sm:z-20 sm:h-10 sm:border-b sm:border-border sm:bg-background/80 sm:px-6 sm:pt-0 sm:backdrop-blur-md animate-fade-in">
