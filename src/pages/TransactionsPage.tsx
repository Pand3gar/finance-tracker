...
export default function TransactionsPage() {
  ...
  return (
    <>
      {/* Header */}
      <header className="sticky top-0 z-30 hidden lg:flex shrink-0 h-10 items-center justify-between border-b border-border bg-background/80 px-6 backdrop-blur-md animate-fade-in">
        <h1 className="font-neuton text-sm font-bold tracking-wide text-foreground hidden sm:block">Transaksi</h1>
      </header>
